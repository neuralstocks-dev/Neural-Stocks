...
def generate_analysis_pdf(analysis: dict) -> bytes:
    ...
    story.append(Spacer(1, 10))
    story.append(Paragraph(
        "This report is generated by Neural Stock Intelligence™ (developed by NeuLab Inc.) using AI models and publicly available market data. "
...
def generate_trade_slip_pdf(analysis: dict, share_url: str = "") -> bytes:
    ...
    doc = SimpleDocTemplate(
        ...
        title=f"NSI Trade Slip · {analysis.get('ticker', '')}",
        author="NeuLab Inc.",
    )
    s = _slip_styles()
    story = []
