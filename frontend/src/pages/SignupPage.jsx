...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen w-full relative overflow-hidden" data-testid="signup-page">
            <div
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(ellipse at 30% 50%, rgba(245,158,11,0.08), transparent 60%), linear-gradient(180deg, rgba(10,12,16,0.55) 0%, rgba(10,12,16,0.88) 100%)",
                }}
            />
            ...
            <div className="relative z-10 min-h-screen grid md:grid-cols-2">
                ...
                <div className="flex items-center justify-center p-6 md:p-12">
                    ...
                    >
                        ...
                        <h2 className="font-serif text-white" style={{ fontSize: "2.4rem", lineHeight: 1, letterSpacing: "-0.02em" }}>
                            Open your ledger.
                        </h2>
                        ...
                        <form onSubmit={onSubmit} className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    <User size={14} strokeWidth={1.5} className="absolute left-3 top-1/2 -translate-y-1/2 text-white/40" />
                                    <input
                                        type="text"
                                        value={fullName}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <Mail size={14} strokeWidth={1.5} className="absolute left-3 top-1/2 -translate-y-1/2 text-white/40" />
                                    <input
                                        type="email"
                                        value={email}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <Lock size={14} strokeWidth={1.5} className="absolute left-3 top-1/2 -translate-y-1/2 text-white/40" />
                                    <input
                                        type="password"
                                        value={password}
                        ...
                        <p className="text-white/60 text-sm mt-6 text-center" style={{ fontFamily: "'Outfit', sans-serif" }}>
                            Already onboarded?{" "}
                            <Link to="/login" className="link-underline text-white font-medium" data-testid="link-to-login">
                                Sign in
                            </Link>
                        </p>
                    </div>
