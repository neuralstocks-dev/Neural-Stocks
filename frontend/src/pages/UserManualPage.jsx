                ...
                <Section id="verdict-anatomy" icon={Compass} kicker="2.4" title="Anatomy of a verdict page">
                    <div className="mt-2 space-y-4 text-sm">
                        {[
                            ...
                            ["9 · Intrinsic value anchor", "A single-period fair-value estimate \u2014 Graham Number for asset-heavy sectors, Residual Income Model for intangible-heavy ones \u2014 not a multi-year DCF. Shows current price vs the estimate. A stock trading significantly above it is pricing in growth or quality the anchor doesn\u2019t capture, not necessarily overvalued."],
